...
import 'package:newproject/compunt/listHalls.dart';
import 'package:newproject/compunt/listPackage.dart';
import 'package:http/http.dart' as http;
import 'package:newproject/compunt/listsetion.dart';
...
class _CatagoresState extends State<Halls> {
  Future getData() async {
    var url = "http://192.168.145.252/wedding/index.php";
