...
class AddEditcatagory extends StatefulWidget {
  final catagorylist;
  final index;
  AddEditcatagory({this.catagorylist, this.index});

  @override
  _AddEditcatagoryState createState() => _AddEditcatagoryState();
}

class _AddEditcatagoryState extends State<AddEditcatagory> {
  ...
  Future Upload() async {
    ...
    var url = "http://192.168.145.252/wedding/Addhall/addcategory.php";
  ...
  Future addEditcategroy() async {
    if (catnamecontroler.text != "") {
      if (editMod) {
        var url = "http://192.168.145.252/wedding/Addhall/updatecategory.php";
