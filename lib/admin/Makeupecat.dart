...
import 'package:newproject/admin/AddMakupe.dart';
...
class MakupeCat extends StatefulWidget {
  @override
  _MakupeCatState createState() => _MakupeCatState();
}

class _MakupeCatState extends State<MakupeCat> {
  List catogery = List();
  Future getAllcategory() async {
    var url = "http://192.168.145.252/wedding/makup.php";
          ...
          IconButton(
              ...
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => AddMakupe()));
              })
        ],
      ),
          ...
          itemBuilder: (context, index) {
            return ListTile(
              ...
              trailing: IconButton(
                onPressed: () async {
                  var url =
                      "http://192.168.145.252/wedding/Addmakup/deletcategory.php";
                  var response =
