...
class AddMakupe extends StatefulWidget {
  final catagorylist;
  final index;
  AddMakupe({this.catagorylist, this.index});
  @override
  _AddMakupeState createState() => _AddMakupeState();
}

class _AddMakupeState extends State<AddMakupe> {
  ...
  Future Upload() async {
    ...
    var url = "http://192.168.145.252/wedding/Addmakup/addcategory.php";
  ...
  Future addEditcategroy() async {
    if (catnamecontroler.text != "") {
      if (editMod) {
        var url = "http://192.168.145.252/wedding/Addmakup/updatecategory.php";
